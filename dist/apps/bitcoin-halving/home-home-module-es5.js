...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["home-home-module"], {
  ...
  /*!******************************************************************************************!*\
    !*** /home/segux/bitcoinhalving/node_modules/@angular/cdk/__ivy_ngcc__/fesm2015/a11y.js ***!
    \******************************************************************************************/
  ...
  function node_modulesAngularCdk__ivy_ngcc__Fesm2015A11yJs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
          ...
          */
          function (newItems) {
            if (_this5._activeItem) {
              ...
              var newIndex = itemArray.indexOf(_this5._activeItem);
      ...
      _createClass2(ListKeyManager, [{
        ...
        value: function withTypeAhead() {
          ...
          */
          function (letter) {
            return (
              /** @type {?} */
              _this6._pressedLetters.push(letter)
            );
          ...
          */
          function () {
            return (
              /** @type {?} */
              _this6._pressedLetters.length > 0
            );
          ...
          */
          function (inputString) {
            ...
            var items =
            /** @type {?} */
            _this6._getItemsArray(); // Start at 1 because we want to start searching at the item immediately
            ...
            for (var i = 1; i < items.length + 1; i++) {
              ...
              var index = (
              /** @type {?} */
              _this6._activeItemIndex + i) % items.length;
              /** @type {?} */
        ...
        value: function onKeydown(event) {
          ...
          */
          function (modifier) {
            return !event[modifier] || _this7._allowedModifierKeys.indexOf(modifier) > -1;
          });
    ...
    function (_ListKeyManager) {
      ...
      function ActiveDescendantKeyManager() {
        ...
        return _possibleConstructorReturn(this, _getPrototypeOf2(ActiveDescendantKeyManager).apply(this, arguments));
      }
    ...
    function (_ListKeyManager2) {
      ...
      function FocusKeyManager() {
        ...
        _this8 = _possibleConstructorReturn(this, _getPrototypeOf2(FocusKeyManager).apply(this, arguments));
        _this8._origin = 'program';
        return _this8;
      }
      /**
    ...
    function () {
      ...
      function FocusTrap(_element, _checker, _ngZone, _document) {
        ...
        */
        function () {
          return _this9.focusLastTabbableElement();
        };
        ...
        */
        function () {
          return _this9.focusFirstTabbableElement();
        };
      ...
      _createClass2(FocusTrap, [{
        ...
        value: function attachAnchors() {
          ...
          */
          function () {
            if (!_this10._startAnchor) {
              _this10._startAnchor = _this10._createAnchor();

              /** @type {?} */
              _this10._startAnchor.addEventListener('focus', _this10.startAnchorListener);
            }

            if (!_this10._endAnchor) {
              _this10._endAnchor = _this10._createAnchor();

              /** @type {?} */
              _this10._endAnchor.addEventListener('focus', _this10.endAnchorListener);
            }
          });
        ...
        value: function focusInitialElementWhenReady() {
          ...
          */
          function (resolve) {
            _this11._executeOnStable(
            /**
            * @return {?}
            */
            function () {
              return resolve(_this11.focusInitialElement());
            });
          });
        }
        /**
        ...
        value: function focusFirstTabbableElementWhenReady() {
          ...
          */
          function (resolve) {
            _this12._executeOnStable(
            /**
            * @return {?}
            */
            function () {
              return resolve(_this12.focusFirstTabbableElement());
            });
          });
        }
        /**
        ...
        value: function focusLastTabbableElementWhenReady() {
          ...
          */
          function (resolve) {
            _this13._executeOnStable(
            /**
            * @return {?}
            */
            function () {
              return resolve(_this13.focusLastTabbableElement());
            });
          });
        }
        /**
    ...
    function (_FocusTrap) {
      ...
      function ConfigurableFocusTrap(_element, _checker, _ngZone, _document, _focusTrapManager, _inertStrategy, config) {
        ...
        _this14 = _possibleConstructorReturn(this, _getPrototypeOf2(ConfigurableFocusTrap).call(this, _element, _checker, _ngZone, _document, config.defer));
        _this14._focusTrapManager = _focusTrapManager;
        _this14._inertStrategy = _inertStrategy;

        _this14._focusTrapManager.register(_assertThisInitialized(_this14));
    ...
    function () {
      ...
      _createClass2(EventListenerFocusTrapInertStrategy, [{
        ...
        value: function preventFocus(focusTrap) {
          ...
          */
          function (e) {
            return _this15._trapFocus(focusTrap, e);
          };
        ...
        value: function announce(message) {
          ...
          */
          function () {
            ...
            */
            function (resolve) {
              clearTimeout(_this16._previousTimeout);
              _this16._previousTimeout = setTimeout(
              /**
              * @return {?}
              */
              function () {
                _this16._liveElement.textContent = message;
                resolve();
      ...
      _createClass2(CdkAriaLive, [{
        ...
        set: function set(value) {
          ...
          if (this._politeness === 'off') {
            ...
            */
            function () {
              return _this17._contentObserver.observe(_this17._elementRef).subscribe(
              /**
              * @return {?}
              */
              function () {
                ...
                /** @type {?} */
                var elementText = _this17._elementRef.nativeElement.textContent; // The `MutationObserver` fires also for attribute
                // changes which we don't want to announce.

                if (elementText !== _this17._previousAnnouncedText) {
                  _this17._liveAnnouncer.announce(elementText, _this17._politeness);

                  _this17._previousAnnouncedText = elementText;
                }
              });
            });
          }
    ...
    function () {
      ...
      function FocusMonitor(_ngZone, _platform) {
        ...
        */
        function () {
          ...
          _this18._lastTouchTarget = null;

          _this18._setOriginForCurrentEventQueue('keyboard');
        };
        /**
        ...
        */
        function () {
          ...
          if (!_this18._lastTouchTarget) {
            _this18._setOriginForCurrentEventQueue('mouse');
          }
        };
        /**
        ...
        */
        function (event) {
          ...
          if (_this18._touchTimeoutId != null) {
            clearTimeout(_this18._touchTimeoutId);
          } // Since this listener is bound on the `document` level, any events coming from the shadow DOM
          // will have their `target` set to the shadow root. If available, use `composedPath` to
          // figure out the event target.


          _this18._lastTouchTarget = event.composedPath ? event.composedPath()[0] : event.target;
          _this18._touchTimeoutId = setTimeout(
          /**
          * @return {?}
          */
          function () {
            return _this18._lastTouchTarget = null;
          }, TOUCH_BUFFER_MS);
        };
        /**
        ...
        */
        function () {
          ...
          _this18._windowFocused = true;
          _this18._windowFocusTimeoutId = setTimeout(
          /**
          * @return {?}
          */
          function () {
            return _this18._windowFocused = false;
          });
        };
      }
      /**
      ...
      _createClass2(FocusMonitor, [{
        ...
        value: function monitor(element) {
          ...
          */
          function focusListener(event) {
            return _this19._onFocus(event, nativeElement);
          };
          /** @type {?} */
          ...
          */
          function blurListener(event) {
            return _this19._onBlur(event, nativeElement);
          };
        ...
        value: function ngOnDestroy() {
          ...
          */
          function (_info, element) {
            return _this20.stopMonitoring(element);
          });
        }
        /**
         * @private
        ...
        value: function _setOriginForCurrentEventQueue(origin) {
          ...
          */
          function () {
            _this21._origin = origin; // Sometimes the focus origin won't be valid in Firefox because Firefox seems to focus *one*
            // tick after the interaction event fired. To ensure the focus origin is always correct,
            // the focus origin will be determined at the beginning of the next tick.

            _this21._originTimeoutId = setTimeout(
            /**
            * @return {?}
            */
            function () {
              return _this21._origin = null;
            }, 1);
          });
        }
        /**
        ...
        value: function _incrementMonitoredElementCount() {
          ...
          if (++this._monitoredElementCount == 1 && this._platform.isBrowser) {
            ...
            */
            function () {
              document.addEventListener('keydown', _this22._documentKeydownListener, captureEventListenerOptions);
              document.addEventListener('mousedown', _this22._documentMousedownListener, captureEventListenerOptions);
              document.addEventListener('touchstart', _this22._documentTouchstartListener, captureEventListenerOptions);
              window.addEventListener('focus', _this22._windowFocusListener);
            });
          }
        }
        /**
    ...
    function () {
      ...
      function CdkMonitorFocus(_elementRef, _focusMonitor) {
        ...
        */
        function (origin) {
          return _this23.cdkFocusChange.emit(origin);
        });
      }
      /**
       * @return {?}
  ...
  /*!******************************************************************************************!*\
    !*** /home/segux/bitcoinhalving/node_modules/@angular/cdk/__ivy_ngcc__/fesm2015/bidi.js ***!
    \******************************************************************************************/
  ...
  "../../node_modules/@angular/cdk/__ivy_ngcc__/fesm2015/keycodes.js":
  /*!**********************************************************************************************!*\
    !*** /home/segux/bitcoinhalving/node_modules/@angular/cdk/__ivy_ngcc__/fesm2015/keycodes.js ***!
    \**********************************************************************************************/
  ...
  function node_modulesAngularCdk__ivy_ngcc__Fesm2015KeycodesJs(module, __webpack_exports__, __webpack_require__) {
    ...
    function hasModifierKey(event) {
      for (var _len6 = arguments.length, modifiers = new Array(_len6 > 1 ? _len6 - 1 : 0), _key6 = 1; _key6 < _len6; _key6++) {
  ...
  "../../node_modules/@angular/cdk/__ivy_ngcc__/fesm2015/observers.js":
  /*!***********************************************************************************************!*\
    !*** /home/segux/bitcoinhalving/node_modules/@angular/cdk/__ivy_ngcc__/fesm2015/observers.js ***!
    \***********************************************************************************************/
    ...
    function () {
      ...
      _createClass2(ContentObserver, [{
        ...
        value: function ngOnDestroy() {
          ...
          */
          function (_, element) {
            return _this24._cleanupObserver(element);
          });
        }
        /**
         * @param {?} elementOrRef
        ...
        value: function observe(elementOrRef) {
          ...
          */
          function (observer) {
            /** @type {?} */
            var stream = _this25._observeElement(element);
            /** @type {?} */
            ...
            return (
              ...
              */
              function () {
                ...
                _this25._unobserveElement(element);
              }
            );
          });
        }
    ...
    function () {
      ...
      _createClass2(CdkObserveContent, [{
        ...
        value: function _subscribe() {
          ...
          */
          function () {
            _this26._currentSubscription = (_this26.debounce ? stream.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["debounceTime"])(_this26.debounce)) : stream).subscribe(_this26.event);
          });
        }
        /**
         * @private
  ...
  "../../node_modules/@angular/cdk/__ivy_ngcc__/fesm2015/platform.js":
  /*!**********************************************************************************************!*\
    !*** /home/segux/bitcoinhalving/node_modules/@angular/cdk/__ivy_ngcc__/fesm2015/platform.js ***!
    \**********************************************************************************************/
  ...
  /*!****************************************************************************!*\
    !*** /home/segux/bitcoinhalving/node_modules/@angular/cdk/fesm2015/cdk.js ***!
    \****************************************************************************/
  ...
  "../../node_modules/@angular/cdk/fesm2015/coercion.js":
  /*!*********************************************************************************!*\
    !*** /home/segux/bitcoinhalving/node_modules/@angular/cdk/fesm2015/coercion.js ***!
    \*********************************************************************************/
  ...
  /*!*********************************************************************************************!*\
    !*** /home/segux/bitcoinhalving/node_modules/@angular/common/__ivy_ngcc__/fesm2015/http.js ***!
    \*********************************************************************************************/
  ...
  function node_modulesAngularCommon__ivy_ngcc__Fesm2015HttpJs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass2(HttpHeaders, [{
        ...
        value: function copyFrom(other) {
          ...
          */
          function (key) {
            _this29.headers.set(key,
            /** @type {?} */
            other.headers.get(key));

            _this29.normalizedNames.set(key,
            /** @type {?} */
        ...
        value: function forEach(fn) {
          ...
          */
          function (key) {
            return fn(
            /** @type {?} */
            _this30.normalizedNames.get(key),
            /** @type {?} */
            _this30.headers.get(key));
          });
        }
      }]);
      ...
      if (rawParams.length > 0) {
        ...
        */
        function (param) {
          ...
          var _ref9 = eqIdx == -1 ? [codec.decodeKey(param), ''] : [codec.decodeKey(param.slice(0, eqIdx)), codec.decodeValue(param.slice(eqIdx + 1))],
            ...
            function (update) {
              switch (update.op) {
                ...
                case 's':
                  ...
                  /** @type {?} */
                  _this33.map.get(update.param) : undefined) || [];
                  base.push(
                  /** @type {?} */
                  update.value);
                ...
                case 'd':
                  if (update.value !== undefined) {
                    ...
                    if (_base.length > 0) {
                      /** @type {?} */
                      _this33.map.set(update.param, _base);
                    } else {
                      /** @type {?} */
    ...
    function (_HttpResponseBase) {
      ...
      function HttpHeaderResponse() {
        ...
        _this34 = _possibleConstructorReturn(this, _getPrototypeOf2(HttpHeaderResponse).call(this, init));
        _this34.type = HttpEventType.ResponseHeader;
        return _this34;
      }
      /**
    ...
    function (_HttpResponseBase2) {
      ...
      function HttpResponse() {
        ...
        _this35 = _possibleConstructorReturn(this, _getPrototypeOf2(HttpResponse).call(this, init));
        _this35.type = HttpEventType.Response;
    ...
    function (_HttpResponseBase3) {
      ...
      function HttpErrorResponse(init) {
        ...
        _this36 = _possibleConstructorReturn(this, _getPrototypeOf2(HttpErrorResponse).call(this, init, 0, 'Unknown Error'));
  ...
  /*!***********************************************************************************************!*\
    !*** /home/segux/bitcoinhalving/node_modules/@angular/material/__ivy_ngcc__/fesm2015/card.js ***!
    \***********************************************************************************************/
  ...
  "../../node_modules/@angular/material/__ivy_ngcc__/fesm2015/core.js":
  /*!***********************************************************************************************!*\
    !*** /home/segux/bitcoinhalving/node_modules/@angular/material/__ivy_ngcc__/fesm2015/core.js ***!
    \***********************************************************************************************/
      ...
      return (
        ...
        function (_base2) {
          ...
          function _class() {
            ...
            _this40 = _possibleConstructorReturn(this, (_getPrototypeOf3 = _getPrototypeOf2(_class)).call.apply(_getPrototypeOf3, [this].concat(args)));
      ...
      return (
        ...
        function (_base3) {
          ...
          function _class2() {
            ...
            _this41 = _possibleConstructorReturn(this, (_getPrototypeOf4 = _getPrototypeOf2(_class2)).call.apply(_getPrototypeOf4, [this].concat(args))); // Set the default color that can be specified from the mixin.
      ...
      return (
        ...
        function (_base4) {
          ...
          function _class3() {
            ...
            _this42 = _possibleConstructorReturn(this, (_getPrototypeOf5 = _getPrototypeOf2(_class3)).call.apply(_getPrototypeOf5, [this].concat(args)));
      ...
      return (
        ...
        function (_base5) {
          ...
          function _class4() {
            ...
            _this43 = _possibleConstructorReturn(this, (_getPrototypeOf6 = _getPrototypeOf2(_class4)).call.apply(_getPrototypeOf6, [this].concat(args)));
      ...
      return (
        ...
        function (_base6) {
          ...
          function _class5() {
            ...
            _this44 = _possibleConstructorReturn(this, (_getPrototypeOf7 = _getPrototypeOf2(_class5)).call.apply(_getPrototypeOf7, [this].concat(args)));
            /**
            ...
            _this44.stateChanges = new rxjs__WEBPACK_IMPORTED_MODULE_5__["Subject"]();
            return _this44;
          }
          /**
           * @return {?}
      ...
      return (
        ...
        function (_base7) {
          ...
          function _class6() {
            ...
            _this45 = _possibleConstructorReturn(this, (_getPrototypeOf8 = _getPrototypeOf2(_class6)).call.apply(_getPrototypeOf8, [this].concat(args)));
            /**
            ...
            _this45.initialized = new rxjs__WEBPACK_IMPORTED_MODULE_5__["Observable"](
            /**
            * @param {?} subscriber
            * @return {?}
            */
    ...
    */
    ...
    function (_DateAdapter) {
      ...
      function NativeDateAdapter(matDateLocale, platform) {
        ...
        _this46 = _possibleConstructorReturn(this, _getPrototypeOf2(NativeDateAdapter).call(this));
        /**
        ...
        _get(_getPrototypeOf2(NativeDateAdapter.prototype), "setLocale", _assertThisInitialized(_this46)).call(_assertThisInitialized(_this46), matDateLocale); // IE does its own time zone correction, so we disable this on IE.
    ...
    */
    ...
    function (_angular_platform_bro) {
      ...
      function GestureConfig(_hammerOptions, _commonModule) {
        ...
        _this50 = _possibleConstructorReturn(this, _getPrototypeOf2(GestureConfig).call(this));
        _this50._hammerOptions = _hammerOptions;
        /**
         * List of new event names to add to the gesture support list
         */

        _this50.events = ANGULAR_MATERIAL_SUPPORTED_HAMMER_GESTURES;
        return _this50;
      }
      /**
      ...
      function RippleRenderer(_target, _ngZone, elementOrElementRef, platform) {
        ...
        */
        function (event) {
          ...
          var isSyntheticEvent = _this51._lastTouchStartEvent && Date.now() < _this51._lastTouchStartEvent + ignoreMouseEventsTimeout;

          if (!_this51._target.rippleDisabled && !isFakeMousedown && !isSyntheticEvent) {
            _this51._isPointerDown = true;

            _this51.fadeInRipple(event.clientX, event.clientY, _this51._target.rippleConfig);
          }
        };
        /**
        ...
        */
        function (event) {
          if (!_this51._target.rippleDisabled) {
            // Some browsers fire mouse events after a `touchstart` event. Those synthetic mouse
            // events will launch a second ripple if we don't ignore mouse events for a specific
            // time after a touchstart event.
            _this51._lastTouchStartEvent = Date.now();
            _this51._isPointerDown = true; // Use `changedTouches` so we skip any touches where the user put
            ...
            for (var i = 0; i < touches.length; i++) {
              _this51.fadeInRipple(touches[i].clientX, touches[i].clientY, _this51._target.rippleConfig);
            }
          }
        };
        /**
        ...
        */
        function () {
          if (!_this51._isPointerDown) {
            return;
          }

          _this51._isPointerDown = false; // Fade-out all ripples that are visible and not persistent.

          _this51._activeRipples.forEach(
          /**
          * @param {?} ripple
          * @return {?}
          */
      ...
      _createClass2(RippleRenderer, [{
        ...
        value: function fadeInRipple(x, y) {
          ...
          */
          function () {
            /** @type {?} */
            var isMostRecentTransientRipple = rippleRef === _this52._mostRecentTransientRipple;
            rippleRef.state = 1
            /* VISIBLE */
            ...
            if (!config.persistent && (!isMostRecentTransientRipple || !_this52._isPointerDown)) {
              rippleRef.fadeOut();
            }
          }, duration);
        ...
        value: function setupTriggerEvents(elementOrElementRef) {
          ...
          */
          function () {
            _this53._triggerEvents.forEach(
            /**
            * @param {?} fn
            * @param {?} type
            * @return {?}
        ...
        value: function _removeTriggerEvents() {
          ...
          if (this._triggerElement) {
            ...
            */
            function (fn, type) {
              /** @type {?} */
              _this54._triggerElement.removeEventListener(type, fn, passiveEventOptions);
            });
          }
        }
      }]);
    ...
    function (_MatOptgroupMixinBase2) {
      ...
      function MatOptgroup() {
        ...
        _this55 = _possibleConstructorReturn(this, _getPrototypeOf2(MatOptgroup).apply(this, arguments));
        /**
         * Unique id for the underlying label.
         */

        _this55._labelId = "mat-optgroup-label-".concat(_uniqueOptgroupIdCounter++);
        return _this55;
      }
  ...
  /*!********************************************************************************!*\
    !*** /home/segux/bitcoinhalving/node_modules/luxon/build/cjs-browser/luxon.js ***!
    \********************************************************************************/
  ...
  /***/
  "./src/app/home/components/blockchain-stats/blockchain-stats.component.ts":
  /*!********************************************************************************!*\
    !*** ./src/app/home/components/blockchain-stats/blockchain-stats.component.ts ***!
    \********************************************************************************/

  /*! exports provided: BlockchainStatsComponent */

  /***/
  function srcAppHomeComponentsBlockchainStatsBlockchainStatsComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "BlockchainStatsComponent", function () {
      return BlockchainStatsComponent;
    });
    /* harmony import */
    ...
    var _services_blockchain_blockchain_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ../../services/blockchain/blockchain.service */
    "./src/app/home/services/blockchain/blockchain.service.ts");
    /* harmony import */
    ...
    function BlockchainStatsComponent_mat_card_0_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-card");

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "mat-card-title-group");
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](9, "mat-card-actions", 1);
      ...
      if (rf & 2) {
        var stats_r1 = ctx.ngIf;

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](7);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate"](_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpipeBind2"](8, 1, stats_r1 == null ? null : stats_r1.data == null ? null : stats_r1.data.countdowns[0] == null ? null : stats_r1.data.countdowns[0].dateTime == null ? null : stats_r1.data.countdowns[0].dateTime.toJSDate(), "full"));
      }
    }

    var BlockchainStatsComponent =
    /*#__PURE__*/
    function () {
      function BlockchainStatsComponent(blockchainService) {
        _classCallCheck(this, BlockchainStatsComponent);

        this.blockchainService = blockchainService;
        this.test = Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])('test');
      }

      _createClass2(BlockchainStatsComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          this.stats$ = this.blockchainService.getStats().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (stats) {
            stats.data.countdowns[0].dateTime = luxon__WEBPACK_IMPORTED_MODULE_3__["DateTime"].local().plus({
    ...
    BlockchainStatsComponent.ɵfac = function BlockchainStatsComponent_Factory(t) {
      return new (t || BlockchainStatsComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_blockchain_blockchain_service__WEBPACK_IMPORTED_MODULE_1__["BlockchainService"]));
    };

    BlockchainStatsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: BlockchainStatsComponent,
      selectors: [["ng-component"]],
      decls: 2,
      vars: 3,
      consts: [[4, "ngIf"], ["align", "start"]],
      template: function BlockchainStatsComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](0, BlockchainStatsComponent_mat_card_0_Template, 12, 4, "mat-card", 0);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpipe"](1, "async");
        }

        if (rf & 2) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngIf", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpipeBind1"](1, 1, ctx.stats$));
        }
      },
      directives: [_angular_common__WEBPACK_IMPORTED_MODULE_5__["NgIf"], _angular_material_card__WEBPACK_IMPORTED_MODULE_6__["MatCard"], _angular_material_card__WEBPACK_IMPORTED_MODULE_6__["MatCardTitleGroup"], _angular_material_card__WEBPACK_IMPORTED_MODULE_6__["MatCardTitle"], _angular_material_card__WEBPACK_IMPORTED_MODULE_6__["MatCardSubtitle"], _angular_material_card__WEBPACK_IMPORTED_MODULE_6__["MatCardContent"], _angular_material_card__WEBPACK_IMPORTED_MODULE_6__["MatCardActions"], _angular_material_card__WEBPACK_IMPORTED_MODULE_6__["MatCardFooter"]],
      pipes: [_angular_common__WEBPACK_IMPORTED_MODULE_5__["AsyncPipe"], _angular_common__WEBPACK_IMPORTED_MODULE_5__["DatePipe"]],
      styles: ["\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJhcHBzL2JpdGNvaW4taGFsdmluZy9zcmMvYXBwL2hvbWUvY29tcG9uZW50cy9ibG9ja2NoYWluLXN0YXRzL2Jsb2NrY2hhaW4tc3RhdHMuY29tcG9uZW50LnNjc3MifQ== */"]
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](BlockchainStatsComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
        ...
        return [{
          type: _services_blockchain_blockchain_service__WEBPACK_IMPORTED_MODULE_1__["BlockchainService"]
        }];
      }, null);
    })();
    /***/
  ...
  function srcAppHomeHomeModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _services_blockchain_blockchain_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./services/blockchain/blockchain.service */
    "./src/app/home/services/blockchain/blockchain.service.ts");
    /* harmony import */


    var _components_blockchain_stats_blockchain_stats_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./components/blockchain-stats/blockchain-stats.component */
    "./src/app/home/components/blockchain-stats/blockchain-stats.component.ts");
    /* harmony import */
    ...
    HomeModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      ...
      providers: [_services_blockchain_blockchain_service__WEBPACK_IMPORTED_MODULE_4__["BlockchainService"]],
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _home_routing_module__WEBPACK_IMPORTED_MODULE_2__["HomeRoutingModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_6__["HttpClientModule"], _angular_material_card__WEBPACK_IMPORTED_MODULE_7__["MatCardModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](HomeModule, {
        declarations: [_pages_home_home_page__WEBPACK_IMPORTED_MODULE_3__["HomePage"], _components_blockchain_stats_blockchain_stats_component__WEBPACK_IMPORTED_MODULE_5__["BlockchainStatsComponent"]],
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _home_routing_module__WEBPACK_IMPORTED_MODULE_2__["HomeRoutingModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_6__["HttpClientModule"], _angular_material_card__WEBPACK_IMPORTED_MODULE_7__["MatCardModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  function srcAppHomePagesHomeHomePageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_blockchain_stats_blockchain_stats_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ../../components/blockchain-stats/blockchain-stats.component */
    "./src/app/home/components/blockchain-stats/blockchain-stats.component.ts");
    ...
    /*#__PURE__*/
    function () {
      function HomePage(componentFactoryResolver, injector) {
      ...
      _createClass2(HomePage, [{
        ...
        key: "createCountdownComponent",
        value: function createCountdownComponent() {
          var countdownElement = document.querySelector('#countdown');
          var factory = this.componentFactoryResolver.resolveComponentFactory(_components_blockchain_stats_blockchain_stats_component__WEBPACK_IMPORTED_MODULE_1__["BlockchainStatsComponent"]);
    ...
    HomePage.ɵfac = function HomePage_Factory(t) {
      return new (t || HomePage)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_0__["ComponentFactoryResolver"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injector"]));
    };

    HomePage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: HomePage,
      selectors: [["bitcoinhalving-home"]],
      decls: 2,
      vars: 0,
      ...
      styles: ["\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJhcHBzL2JpdGNvaW4taGFsdmluZy9zcmMvYXBwL2hvbWUvcGFnZXMvaG9tZS9ob21lLnBhZ2Uuc2NzcyJ9 */"]
    });
    /*@__PURE__*/
  ...
  /***/
  function srcAppHomeServicesBlockchainBlockchainServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    function () {
      ...
      _createClass2(BlockchainService, [{
        key: "getStats",
        value: function getStats() {
          return this.httpClient.get('https://api.blockchair.com/bitcoin/stats').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["tap"])(function (response) {
    ...
    BlockchainService.ɵfac = function BlockchainService_Factory(t) {
      return new (t || BlockchainService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"]));
    };
